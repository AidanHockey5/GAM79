...
public class PlayerControl : NetworkBehaviour 
{
	...
	public void CmdSpawn(SpawnClass sClass)
	{
		...
		case global::SpawnClass.Technician:
			GameObject obj = (GameObject)Instantiate (CustomNetworkManager.Instance.spawnPrefabs [3], SpawnPointManager.Instance.SpawnPointLocation (), Quaternion.identity);
		...
		case global::SpawnClass.Support:
			GameObject obj2 = (GameObject)Instantiate (CustomNetworkManager.Instance.spawnPrefabs [0], SpawnPointManager.Instance.SpawnPointLocation (), Quaternion.identity);
			NetworkServer.Destroy (this.gameObject);
		...
		case global::SpawnClass.Heavy:
			GameObject obj3 = (GameObject)Instantiate (CustomNetworkManager.Instance.spawnPrefabs [4], SpawnPointManager.Instance.SpawnPointLocation (), Quaternion.identity);
			NetworkServer.Destroy (this.gameObject);
		...
		case global::SpawnClass.Assault:
			GameObject obj4 = (GameObject)Instantiate (CustomNetworkManager.Instance.spawnPrefabs [5], SpawnPointManager.Instance.SpawnPointLocation (), Quaternion.identity);
			NetworkServer.Destroy (this.gameObject);
