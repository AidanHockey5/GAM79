...
public class MonsterStateExecutor : MonoBehaviour 
{
	public List<MonsterState> monsterStates = new List<MonsterState> ();
	...
	void Start () 
	{
		...
		stateMachine.Initialize<MonsterState> (this);
		stateMachine.ChangeState (MonsterState.NONE);
	}
