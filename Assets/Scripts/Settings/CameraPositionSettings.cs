...
public class CameraPositionSettings
{
	...
	public CameraPositionSettings()
	{
		
	}

	public CameraPositionSettings(Vector3 tarPosOffset, float lookSmooth, float distFromTar, float zoomSmooth, float maxZoom, float minZoom)
	{
